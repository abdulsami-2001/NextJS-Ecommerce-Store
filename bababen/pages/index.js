...
export default function Home() {
  return (
    <div>
      <Head>
        <title>BabaBen</title>
        <meta name="description" content="BabaBen For My Baba" />
        <link rel="icon" href="/favicon.ico" />
      </Head>

      <div className='bg-orange-600' >Hello Bababen</div>
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto">
          ...
          <button className="flex mx-auto mt-16 text-black bg-black-500 border-0 py-2 px-8 focus:outline-none hover:bg-black-600 rounded text-lg">Button</button>
        </div>
      </section>
    </div>
  )
